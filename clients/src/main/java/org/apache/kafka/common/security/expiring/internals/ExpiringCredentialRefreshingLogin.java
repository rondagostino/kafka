        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    Set<ClientChannelCredentialTracker> channelCredentialMgrInstances = subject
                            .getPrivateCredentials(ClientChannelCredentialTracker.class);
                    if (!channelCredentialMgrInstances.isEmpty())
                        channelCredentialMgrInstances.iterator().next().offer(ClientChannelCredentialEvent
                                .credentialRefreshed(time, expiringCredentialPriorToReLogin, expiringCredential));
                }
