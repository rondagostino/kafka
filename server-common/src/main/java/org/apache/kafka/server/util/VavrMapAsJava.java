...
public class VavrMapAsJava<K, V> extends AbstractMap<K, V> {
    ...
    private class AsEntrySet extends BaseImmutableSet<Entry<K, V>> {
        ...
        public Iterator<Entry<K, V>> iterator() {
            return VavrMapAsJava.this.vavrMap.iterator(SimpleImmutableEntry::new);
        }
    }

    private final io.vavr.collection.Map<K, V> vavrMap;

    public VavrMapAsJava(io.vavr.collection.Map<K, V> vavrMap) {
    ...
    public boolean containsValue(Object value) {
        ...
        return vavrMap.containsValue((V) value);
    }
    ...
    public V get(Object key) {
        // inherited implementation has O(N) performance, so must override
        return vavrMap.getOrElse((K) key, null);
    }
